...
class ADKAgentDiscoveryTester:
    ...
    def start_servers(self) -> bool:
        ...
        # Start API server
        try:
            api_cmd = ["adk", "api_server", "video_system", "--port", str(self.api_port)]
        ...
        for agent in test_agents:
            try:
                ...
                try:
                    ...
                    process.kill()
                    print(f"      ✅ {agent} started successfully (killed after timeout)")
    ...
    def test_orchestrator_execution(self) -> bool:
        ...
        try:
            ...
            try:
                ...
                process.kill()
                print("   ✅ Video orchestrator started successfully (killed after timeout)")
                return True
