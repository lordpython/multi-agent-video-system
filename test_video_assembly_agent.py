...
sys.modules['video_system.tools.video_tools'].check_ffmpeg_health = mock_check_ffmpeg_health
sys.modules['video_system.tools.video_tools'].ffmpeg_composition_tool = mock_ffmpeg_composition_tool
sys.modules['video_system.tools.video_tools'].video_synchronization_tool = mock_video_synchronization_tool
sys.modules['video_system.tools.video_tools'].transition_effects_tool = mock_transition_effects_tool
sys.modules['video_system.tools.video_tools'].video_encoding_tool = mock_video_encoding_tool
...
sys.modules['video_system.utils.error_handling'].get_logger = MagicMock(return_value=mock_logger)
sys.modules['video_system.utils.resilience'].get_health_monitor = MagicMock(return_value=mock_health_monitor)
...
class TestVideoAssemblyAgent(unittest.TestCase):
    ...
    def test_health_check(self):
        ...
        from video_system.agents.video_assembly_agent.agent import check_video_assembly_health
        ...
        self.assertEqual(result["details"]["message"], "Video assembly services are operational")
