...
def save_images_to_files(result: Dict[str, Any], output_dir: str = "generated_images") -> List[str]:
    """
...
def print_image_generation_summary(result: Dict[str, Any], save_files: bool = True) -> None:
    """
