...
async def test_toolcontext_integration():
    ...
    try:
        # Test research tool
        research_result = await coordinate_research_tool.func("renewable energy technology")
        ...
        # Test story tool
        story_result = await coordinate_story_tool.func(research_result["research_data"], 60)
