...
class ImagenGenerationInput(BaseModel):
    ...
    aspect_ratio: str = Field(
        default="1:1",
        description="Image aspect ratio: '1:1', '9:16', '16:9', '4:3', '3:4'",
    )
    number_of_images: int = Field(
        default=1, description="Number of images to generate (1-8)"
    )
    person_generation: str = Field(
        default="ALLOW_ADULT",
        description="Person generation policy: 'ALLOW_ADULT', 'BLOCK_SOME'",
    )
    output_mime_type: str = Field(
        default="image/jpeg", description="Output format: 'image/jpeg' or 'image/png'"
    )
