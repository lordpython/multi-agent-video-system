...
def search_stock_images(query: str, count: int = 5) -> Dict[str, Any]:
    ...
    return {"images": images, "total_results": count, "query": query, "success": True}
...
def search_stock_videos(query: str, count: int = 3) -> Dict[str, Any]:
    ...
    return {"videos": videos, "total_results": count, "query": query, "success": True}
...
def check_pexels_health() -> Dict[str, Any]:
    ...
    return {"status": "healthy", "details": {"message": "Pexels API is operational"}}
