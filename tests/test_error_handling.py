...
class TestResilienceComponents:
    ...
    def test_service_registry_health_check_failure(self):
        ...
        registry.register_service("test_service", health_check_func=failing_health_check)
    ...
    def test_resource_monitor_metrics(self, mock_disk, mock_memory, mock_cpu):
        ...
        mock_memory.return_value = Mock(percent=60.0, available=4*1024**3)  # 4GB available
...
class TestAgentErrorScenarios:
    ...
    def test_ffmpeg_composition_missing_ffmpeg(self, mock_which):
        ...
        with patch('sub_agents.video_assembly.tools.ffmpeg_composition._check_ffmpeg_availability', return_value=False):
    ...
    def test_file_system_errors(self):
        ...
        with patch('os.makedirs') as mock_makedirs:
            ...
            result = compose_video_with_ffmpeg(request)
            assert result.success is False
            assert "permission" in result.error_message.lower() or "directory" in result.error_message.lower()
