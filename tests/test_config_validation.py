...
class TestConfigurationManager:
    ...
    def test_json_config_file_loading(self):
        ...
        config_data = {
            "google_cloud": {"project_id": "json-project", "location": "europe-west1"},
            "performance": {"max_concurrent_requests": 15},
            "video_processing": {"video_quality": "ultra", "default_video_fps": 60},
        }
    ...
    def test_yaml_config_file_loading(self):
        ...
        config_data = {
            "google_cloud": {"project_id": "yaml-project", "use_vertexai": False},
            "logging": {"log_level": "WARNING", "enable_structured_logging": False},
        }
...
"""
    ...
    def test_configuration_precedence(self):
        ...
        with patch.dict(
            os.environ, {"GOOGLE_CLOUD_PROJECT": "env-project"}, clear=True
        ):
            # Create config file with different value
            config_data = {"google_cloud": {"project_id": "file-project"}}
    ...
    def test_integer_environment_parsing(self):
        ...
        for env_value, expected in test_cases:
            with patch.dict(
                os.environ, {"MAX_CONCURRENT_REQUESTS": env_value}, clear=True
            ):
                config_manager = ConfigurationManager()
    ...
    def test_float_environment_parsing(self):
        ...
        for env_value, expected in test_cases:
            with patch.dict(
                os.environ, {"DEFAULT_REQUESTS_PER_SECOND": env_value}, clear=True
            ):
                config_manager = ConfigurationManager()
...
class TestConfigurationValidation:
    ...
    def test_invalid_staging_bucket(self):
        ...
        invalid_env = {"STAGING_BUCKET": "invalid-bucket-format"}
    ...
    def test_invalid_video_resolution(self):
        ...
        invalid_env = {"DEFAULT_VIDEO_RESOLUTION": "invalid-resolution"}
