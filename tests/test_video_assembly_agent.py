...
class TestVideoAssemblyAgent:
    ...
    def test_ffmpeg_composition_tool(self, mock_metadata, mock_duration, mock_subprocess):
    ...
    def test_integration_workflow_simulation(self):
        ...
        sync_request = SynchronizationRequest(
            ...
            audio_segments=[
                {'duration': 3.0, 'text': 'Hello world', 'scene_number': 1, 'audio_file': 'audio1.wav'},
                {'duration': 2.0, 'text': 'Goodbye', 'scene_number': 2, 'audio_file': 'audio2.wav'}
            ],
