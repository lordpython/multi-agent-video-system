...
async def test_api_imports():
    ...
    try:
        ...
        from video_system.api.cli import root_agent as cli_root_agent
...
async def test_agent_structure():
    ...
    try:
        ...
        from video_system.agents.research_agent.agent import (
            root_agent as research_agent,
        )
...
async def test_tools_imports():
    ...
    try:
        ...
        # Test tools imports
        import video_system.tools.research_tools

        print("✓ Research tools imported")

        import video_system.tools.story_tools

        print("✓ Story tools imported")

        import video_system.tools.asset_tools

        print("✓ Asset tools imported")

        import video_system.tools.image_tools

        print("✓ Image tools imported")

        import video_system.tools.audio_tools

        print("✓ Audio tools imported")

        import video_system.tools.video_tools
